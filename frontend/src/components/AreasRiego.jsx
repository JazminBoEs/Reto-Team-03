...
const AreasRiego = ({ setVistaActual, setParcelaActiva }) => {
    ...
    const cargarDatosDinamicos = async () => {
      try {
        ...
        const [resAreas, resConfig, resMediciones] = await Promise.all([
          fetch(`${API_BASE_URL}/areas-riego`),
    ...
    <div className="animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        {parcelas.length === 0 && !cargando && (
          <div className="col-span-full p-10 border border-white/10 rounded-[2rem] text-center text-gray-500">
